...
class NetworkJulesJordanSpider(BaseSceneScraper):
    name = 'JulesJordanNetwork'
    network = 'julesjordan'

    start_urls = [
        # 'https://www.julesjordan.com', Moved to JulesJordan Site level Scraper
    ...
    selector_map = {
        'title': '//span[@class="title_bar_hilite"]/text()|//div[@class="movie_title"]/text()|//h1[@class="movie_title"]/text()',
