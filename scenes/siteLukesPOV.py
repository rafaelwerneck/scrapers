...
class SiteLukesPOVSpider(BaseSceneScraper):
    ...
    selector_map = {
        ...
        'performers': '//strong[contains(text(), "Starring")]/a/text()|//h2[contains(text(), "Starring")]/a/text()',
        'tags': '//p[contains(text(), "Tags")]/following-sibling::div/a[contains(@href, "/tag/")]/text()',
