...
class SiteDrRideoutSpider(BaseSceneScraper):
    ...
    async def start(self):
        meta = {}
        meta['page'] = self.page
        yield scrapy.Request('https://drrideout.com', callback=self.start_requests_2, meta=meta, headers=self.headers, cookies=self.cookies)
    ...
    def get_scenes(self, response):
        ...
        if jsondata:
            ...
            for scene in jsondata['data']:
                ...
                item['url'] = f"https://drrideout.com/videos/{scene['slug']}"
